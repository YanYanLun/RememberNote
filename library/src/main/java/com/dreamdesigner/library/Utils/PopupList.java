...
public abstract class PopupList {
    ...
    protected abstract void OnNoteLongClick(View view, int position);

    protected abstract void OnNoteClick(View view, int position);
    ...
    public void init(Context context, View anchorView, List<String> popupItemList, OnPopupListClickListener onPopupListClickListener) {
        ...
        if (mAnchorView instanceof RecyclerView) {
            ((RecyclerView) mAnchorView).addOnItemTouchListener(new RecyclerItemClickListener(mContext, (RecyclerView) mAnchorView, new RecyclerItemClickListener.OnItemClickListener() {
                @Override
    ...
    protected void showPopupListWindow() {
