package com.dreamdesigner.library.funswitch;
...
public class FunSwitch extends View implements ValueAnimator.AnimatorUpdateListener, ValueAnimator.AnimatorListener {
    ...
    private void startColorAnimation() {
        ...
        if (listener != null)
            listener.OnChangeState(mIsOpen ? false : true);
    }
    ...
    public OnFunSwitchLinstener listener;

    public void setOnFunSwitchLinstener(OnFunSwitchLinstener listener) {
        this.listener = listener;
    }

    public interface OnFunSwitchLinstener {
