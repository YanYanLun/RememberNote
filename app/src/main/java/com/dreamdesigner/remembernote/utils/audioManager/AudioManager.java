...
public class AudioManager {
    ...
    public void prepareAudio() {
        ...
        try {
            ...
            if (mediaRecorderListener != null)
                mediaRecorderListener.getMediaRecorder(mMediaRecorder);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private onGetMediaRecorderListener mediaRecorderListener;

    public void setOnGetMediaRecorderListener(onGetMediaRecorderListener mediaRecorderListener) {
        this.mediaRecorderListener = mediaRecorderListener;
    }

    public interface onGetMediaRecorderListener {
