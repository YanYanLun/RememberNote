...
import com.dreamdesigner.remembernote.utils.audioManager.AudioManager;
import com.dreamdesigner.remembernote.utils.audioManager.DialogManager;


/**
 * Created by cooffee on 15/10/19.
 */
public class AudioRecorderButton extends AppCompatButton implements AudioManager.AudioStateListener, AudioManager.onGetMediaRecorderListener {
    ...
    public AudioRecorderButton(Context context, AttributeSet attrs) {
        ...
        String dir = StaticValueUtils.Voice_Route;
        mAudioManager = AudioManager.getInstance(dir);
        mAudioManager.setOnAudioStateListner(this);
        mAudioManager.setOnGetMediaRecorderListener(this);
...
//                    mDialogManager.showRecordingDialog();
    ...
    private void changeState(int state) {
        if (mCurState != state) {
            ...
            switch (mCurState) {
                case STATE_NORMAL:
                    setBackground(getResources().getDrawable(R.mipmap.voice_blue));
//                    setText(R.string.str_recorder_normal);
                    break;
                case STATE_RECORDING:
                    setBackground(getResources().getDrawable(R.mipmap.voice_white));
...
//                    setText(R.string.str_recorder_want_cancel);
    ...
    public void getMediaRecorder(MediaRecorder mediaRecorder) {
        if (mediaRecorder != null)
            mDialogManager.onMessageEvent(mediaRecorder);
    }
}
